...
<head>
  ...
  <title>ITAYETZI | Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>ITAYETZI</b></span>
    </a>
...
if ($_SESSION['escritorio']==1) {
  echo ' <li><a href="escritorio.php"><i class="fa  fa-dashboard (alias)"></i> <span>Administración</span></a>
        </li>';
}
        ?>
               <?php 
